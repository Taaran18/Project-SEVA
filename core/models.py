...
class User(AbstractUser):
    ...
    user_skills = models.TextField(
        name="skills", help_text="Enter your skills separated by comma: skill1, skill2"
    )
    user_dob = models.DateField(null=True)
    ## Organisation Fields
    organisation_name = models.CharField(
        name="organisation_name", max_length=200, null=True
    )
    organisation_designation = models.CharField(
        name="designation", max_length=150, null=True
    )
...
class Education(models.Model):
    user = models.ForeignKey(
        User, limit_choices_to={"user_type": "normal"}, on_delete=models.CASCADE
    )
