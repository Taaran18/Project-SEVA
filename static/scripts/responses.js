function getBotResponse(input) {
    ...
    else if (input == "how much time it takes to register a new user" || input == "new user registration time"){
    ...
    else if (input == "from where can I get details to contact the admin" || input == "contact the admin"){
